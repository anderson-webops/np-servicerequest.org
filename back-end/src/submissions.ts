...
const defaultSubmissionsDirectory = resolve(packageRoot, ".data", "submissions");
...
function buildSubmissionDirectory(kind: SubmissionKind) {
	return resolve(process.env.SUBMISSIONS_DATA_DIR || defaultSubmissionsDirectory, kind);
}
